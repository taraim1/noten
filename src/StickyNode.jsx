...
export default function StickyNode({ data, selected, id, onChangeLabel }) {
  ...
  return (
    ...
    >
      ...
      {/* 연결 포인트들 */}
      <Handle type="source" position={Position.Top} id="s-top" className="react-flow__handle" style={{ backgroundColor: isMobile ? data.color : darken(data.color, 0.8) }} />
      <Handle type="source" position={Position.Right} id="s-right" className="react-flow__handle" style={{ backgroundColor: isMobile ? data.color : darken(data.color, 0.8) }}/>
      <Handle type="source" position={Position.Bottom} id="s-bottom" className="react-flow__handle" style={{ backgroundColor: isMobile ? data.color : darken(data.color, 0.8) }}/>
      <Handle type="source" position={Position.Left} id="s-left" className="react-flow__handle" style={{ backgroundColor: isMobile ? data.color : darken(data.color, 0.8) }}/>
